...
//	 * @param loginedUser
//	 */
//	public static void dropPreviousUser(HttpServletRequest request, SessionRegistry sessionRegistry, User loginedUser,
...
//							// 当前session失效
//							// send message
//							sysMessageService.sendMessage(((User) principal).getUsername(),
//									new SysMessage(null, Consts.NOTIFICATION_TYPE_HADLOGIN_CONTENT, 5,
